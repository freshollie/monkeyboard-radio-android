...
public static String  _astreams_error() throws Exception{
 //BA.debugLineNum = 617;BA.debugLine="Sub Astreams_Error";
 //BA.debugLineNum = 618;BA.debugLine="astreams.Close";
_astreams.Close();
 //BA.debugLineNum = 619;BA.debugLine="CloseService";
_closeservice();
...
int _itemp = 0;
int _y = 0;
 //BA.debugLineNum = 593;BA.debugLine="Sub Astreams_NewData (buffer() As Byte)";
 //BA.debugLineNum = 594;BA.debugLine="Dim itemp As Int";
_itemp = 0;
 //BA.debugLineNum = 595;BA.debugLine="Dim y As Int";
_y = 0;
 //BA.debugLineNum = 597;BA.debugLine="For y = 0 To buffer.Length -1";
{
final int step475 = 1;
final int limit475 = (int) (_buffer.length-1);
for (_y = (int) (0); (step475 > 0 && _y <= limit475) || (step475 < 0 && _y >= limit475); _y = ((int)(0 + _y + step475))) {
 //BA.debugLineNum = 598;BA.debugLine="itemp = Bit.And(0xff, buffer(y))";
_itemp = anywheresoftware.b4a.keywords.Common.Bit.And((int) (0xff),(int) (_buffer[_y]));
 //BA.debugLineNum = 599;BA.debugLine="If itemp = 254 Then";
if (_itemp==254) { 
 //BA.debugLineNum = 600;BA.debugLine="Start = True";
_start = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 601;BA.debugLine="xIndex = 0";
_xindex = (int) (0);
 };
 //BA.debugLineNum = 604;BA.debugLine="If Start Then";
if (_start) { 
 //BA.debugLineNum = 605;BA.debugLine="Ack(xIndex) = itemp";
_ack[_xindex] = _itemp;
 //BA.debugLineNum = 606;BA.debugLine="xIndex = xIndex + 1";
_xindex = (int) (_xindex+1);
 };
 //BA.debugLineNum = 609;BA.debugLine="If itemp = 253 Then";
if (_itemp==253) { 
 //BA.debugLineNum = 610;BA.debugLine="Start = False";
_start = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 611;BA.debugLine="Evaluate(xIndex - 1)";
...
public static String  _astreams_terminated() throws Exception{
 //BA.debugLineNum = 622;BA.debugLine="Sub Astreams_Terminated";
 //BA.debugLineNum = 623;BA.debugLine="CloseService";
_closeservice();
...
public static String  _closeradio() throws Exception{
 //BA.debugLineNum = 471;BA.debugLine="Sub CloseRadio";
 //BA.debugLineNum = 472;BA.debugLine="USB.Close()";
_usb.Close();
 //BA.debugLineNum = 473;BA.debugLine="End Sub";
return "";
}
public static String  _closeservice() throws Exception{
 //BA.debugLineNum = 658;BA.debugLine="Sub CloseService ' Close the background service bu";
 //BA.debugLineNum = 659;BA.debugLine="If ServiceStarted And Connected Then";
if (_servicestarted && _connected) { 
 //BA.debugLineNum = 660;BA.debugLine="SaveSettings";
_savesettings();
 //BA.debugLineNum = 661;BA.debugLine="RunCloseProcesses";
_runcloseprocesses();
 };
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 390;BA.debugLine="Sub DTR(Bool As Boolean)";
 //BA.debugLineNum = 391;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 392;BA.debugLine="r.Target = USB";
_r.Target = (Object)(_usb);
 //BA.debugLineNum = 393;BA.debugLine="r.Target = r.getField(\"driver\")";
_r.Target = _r.GetField("driver");
 //BA.debugLineNum = 394;BA.debugLine="r.RunMethod2(\"setDTR\", Bool, \"java.lang.boolean\")";
...
boolean _changed = false;
 //BA.debugLineNum = 59;BA.debugLine="Sub Evaluate(index As Int)";
 //BA.debugLineNum = 63;BA.debugLine="Dim j As Int";
_j = 0;
 //BA.debugLineNum = 64;BA.debugLine="Dim ArgumentsList As List";
_argumentslist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 72;BA.debugLine="Select Ack(1)";
switch (BA.switchObjectToInt(_ack[(int) (1)],(int) (0x01),(int) (0x00))) {
case 0:
 //BA.debugLineNum = 74;BA.debugLine="Select Ack(2)";
...
case 0:
 //BA.debugLineNum = 77;BA.debugLine="Select Case Ack(6)";
switch (BA.switchObjectToInt(_ack[(int) (6)],(int) (0),(int) (1),(int) (2),(int) (3),(int) (4),(int) (5))) {
case 0:
 //BA.debugLineNum = 80;BA.debugLine="Status = \"Playing\"";
_status = "Playing";
 break;
case 1:
 //BA.debugLineNum = 82;BA.debugLine="Status = \"Searching\"";
_status = "Searching";
 break;
case 2:
 //BA.debugLineNum = 84;BA.debugLine="Status = \"Tunning\"";
_status = "Tunning";
 break;
case 3:
 //BA.debugLineNum = 86;BA.debugLine="Status = \"Stop\"";
_status = "Stop";
 break;
case 4:
 //BA.debugLineNum = 88;BA.debugLine="Status = \"Sorting\"";
_status = "Sorting";
 break;
case 5:
 //BA.debugLineNum = 90;BA.debugLine="Status = \"Reconfiguration\"";
_status = "Reconfiguration";
 break;
default:
 //BA.debugLineNum = 92;BA.debugLine="Status = \"N/A\"";
_status = "N/A";
 break;
}
;
 //BA.debugLineNum = 96;BA.debugLine="labEventText = Status";
_labeventtext = _status;
 break;
case 1:
 //BA.debugLineNum = 99;BA.debugLine="If Ack(6) = 0 Then";
if (_ack[(int) (6)]==0) { 
 //BA.debugLineNum = 100;BA.debugLine="Frequenz = Bit.ParseInt(Bit.ToHexString(Ack(7)";
_frequenz = anywheresoftware.b4a.keywords.Common.Bit.ParseInt(anywheresoftware.b4a.keywords.Common.Bit.ToHexString(_ack[(int) (7)])+anywheresoftware.b4a.keywords.Common.Bit.ToHexString(_ack[(int) (8)])+anywheresoftware.b4a.keywords.Common.Bit.ToHexString(_ack[(int) (9)]),(int) (16));
 //BA.debugLineNum = 101;BA.debugLine="If isDAB And DAB Then";
if (_isdab && _dab) { 
 //BA.debugLineNum = 102;BA.debugLine="labFreqText = Frequenz";
_labfreqtext = BA.NumberToString(_frequenz);
 }else {
 //BA.debugLineNum = 104;BA.debugLine="If Frequenz < 108100 And Frequenz > 87400 The";
...
_labfreqtext = BA.NumberToString(_frequenz/(double)1000);};
 ...
 break;
case 2:
 //BA.debugLineNum = 109;BA.debugLine="Strength = Ack(6)";
_strength = (byte) (_ack[(int) (6)]);
 //BA.debugLineNum = 110;BA.debugLine="If isDAB Then";
if (_isdab) { 
 //BA.debugLineNum = 111;BA.debugLine="labStrengthText = Strength * 6";
_labstrengthtext = BA.NumberToString(_strength*6);
 //BA.debugLineNum = 112;BA.debugLine="pbStrengthProgress = Strength * 6";
_pbstrengthprogress = _strength*6;
 }else {
 //BA.debugLineNum = 114;BA.debugLine="labStrengthText = Strength";
_labstrengthtext = BA.NumberToString(_strength);
 //BA.debugLineNum = 115;BA.debugLine="pbStrengthProgress = Strength";
_pbstrengthprogress = _strength;
 };
 break;
case 3:
 //BA.debugLineNum = 119;BA.debugLine="Select Ack(6)";
switch (BA.switchObjectToInt(_ack[(int) (6)],(int) (0),(int) (1),(int) (2),(int) (3))) {
case 0:
 break;
case 1:
 //BA.debugLineNum = 124;BA.debugLine="StereoModeText = \"Stereo\"";
_stereomodetext = "Stereo";
 break;
case 2:
 //BA.debugLineNum = 126;BA.debugLine="StereoModeText = \"Joint Stereo\"";
_stereomodetext = "Joint Stereo";
 break;
case 3:
 //BA.debugLineNum = 128;BA.debugLine="StereoModeText = \"Dual Channel\"";
_stereomodetext = "Dual Channel";
 break;
case 4:
 //BA.debugLineNum = 130;BA.debugLine="StereoModeText = \"Mono\"";
...
;
 break;
case 4:
 //BA.debugLineNum = 135;BA.debugLine="If Mute Then";
if (_mute) { 
 //BA.debugLineNum = 136;BA.debugLine="labVolumeText = \"--\"";
_labvolumetext = "--";
 }else {
 //BA.debugLineNum = 138;BA.debugLine="labVolumeText = Volume";
_labvolumetext = BA.NumberToString(_volume);
 };
 break;
case 5:
 //BA.debugLineNum = 142;BA.debugLine="ProgramName = \"\"";
_programname = "";
 //BA.debugLineNum = 143;BA.debugLine="For j = 6 To index - 1";
{
final int step95 = 1;
final int limit95 = (int) (_index-1);
for (_j = (int) (6); (step95 > 0 && _j <= limit95) || (step95 < 0 && _j >= limit95); _j = ((int)(0 + _j + step95))) {
 //BA.debugLineNum = 144;BA.debugLine="ProgramName = ProgramName & Chr(Ack(j))";
_programname = _programname+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(_ack[_j]));
 }
};
 //BA.debugLineNum = 146;BA.debugLine="ProgramNameText = ProgramName";
_programnametext = _programname;
 break;
case 6:
 //BA.debugLineNum = 149;BA.debugLine="Select Case Ack(6)";
...
case 0:
 //BA.debugLineNum = 151;BA.debugLine="ProgramType = \"\"";
_programtype = "";
 break;
case 1:
 //BA.debugLineNum = 153;BA.debugLine="ProgramType = \"News\"";
_programtype = "News";
 break;
case 2:
 //BA.debugLineNum = 155;BA.debugLine="ProgramType = \"Current Affairs\"";
_programtype = "Current Affairs";
 break;
case 3:
 //BA.debugLineNum = 157;BA.debugLine="ProgramType = \"Information\"";
_programtype = "Information";
 break;
case 4:
 //BA.debugLineNum = 159;BA.debugLine="ProgramType = \"Sport\"";
_programtype = "Sport";
 break;
case 5:
 //BA.debugLineNum = 161;BA.debugLine="ProgramType = \"Education\"";
_programtype = "Education";
 break;
case 6:
 //BA.debugLineNum = 163;BA.debugLine="ProgramType = \"Drama\"";
_programtype = "Drama";
 break;
case 7:
 //BA.debugLineNum = 165;BA.debugLine="ProgramType = \"Arts\"";
_programtype = "Arts";
 break;
case 8:
 //BA.debugLineNum = 167;BA.debugLine="ProgramType = \"Science\"";
_programtype = "Science";
 break;
case 9:
 //BA.debugLineNum = 169;BA.debugLine="ProgramType = \"Talk\"";
_programtype = "Talk";
 break;
case 10:
 //BA.debugLineNum = 171;BA.debugLine="ProgramType = \"Pop Music\"";
_programtype = "Pop Music";
 break;
case 11:
 //BA.debugLineNum = 173;BA.debugLine="ProgramType = \"Rock Music\"";
_programtype = "Rock Music";
 break;
case 12:
 //BA.debugLineNum = 175;BA.debugLine="ProgramType = \"Easy Listening\"";
_programtype = "Easy Listening";
 break;
case 13:
 //BA.debugLineNum = 177;BA.debugLine="ProgramType = \"Light Classical\"";
_programtype = "Light Classical";
 break;
case 14:
 //BA.debugLineNum = 179;BA.debugLine="ProgramType = \"Classical Music\"";
_programtype = "Classical Music";
 break;
case 15:
 //BA.debugLineNum = 181;BA.debugLine="ProgramType = \"Other Music\"";
_programtype = "Other Music";
 break;
case 16:
 //BA.debugLineNum = 183;BA.debugLine="ProgramType = \"Weather\"";
_programtype = "Weather";
 break;
case 17:
 //BA.debugLineNum = 185;BA.debugLine="ProgramType = \"Finance\"";
_programtype = "Finance";
 break;
case 18:
 //BA.debugLineNum = 187;BA.debugLine="ProgramType = \"Children\"";
_programtype = "Children";
 break;
case 19:
 //BA.debugLineNum = 189;BA.debugLine="ProgramType = \"Factual\"";
_programtype = "Factual";
 break;
case 20:
 //BA.debugLineNum = 191;BA.debugLine="ProgramType = \"Religion\"";
_programtype = "Religion";
 break;
case 21:
 //BA.debugLineNum = 193;BA.debugLine="ProgramType = \"Phone In\"";
_programtype = "Phone In";
 break;
case 22:
 //BA.debugLineNum = 195;BA.debugLine="ProgramType = \"Travel\"";
_programtype = "Travel";
 break;
case 23:
 //BA.debugLineNum = 197;BA.debugLine="ProgramType = \"Leisure\"";
_programtype = "Leisure";
 break;
case 24:
 //BA.debugLineNum = 199;BA.debugLine="ProgramType = \"Jazz and Blues\"";
_programtype = "Jazz and Blues";
 break;
case 25:
 //BA.debugLineNum = 201;BA.debugLine="ProgramType = \"Country Music\"";
_programtype = "Country Music";
 break;
case 26:
 //BA.debugLineNum = 203;BA.debugLine="ProgramType = \"National Music\"";
_programtype = "National Music";
 break;
case 27:
 //BA.debugLineNum = 205;BA.debugLine="ProgramType = \"Oldies Music\"";
_programtype = "Oldies Music";
 break;
case 28:
 //BA.debugLineNum = 207;BA.debugLine="ProgramType = \"Folk Music\"";
_programtype = "Folk Music";
 break;
case 29:
 //BA.debugLineNum = 209;BA.debugLine="ProgramType = \"Documentary\"";
_programtype = "Documentary";
 break;
case 30:
 //BA.debugLineNum = 211;BA.debugLine="ProgramType = \"Undefined\"";
_programtype = "Undefined";
 break;
case 31:
 //BA.debugLineNum = 213;BA.debugLine="ProgramType = \"Undefined\"";
_programtype = "Undefined";
 break;
default:
 //BA.debugLineNum = 215;BA.debugLine="ProgramType = \"\"";
_programtype = "";
 break;
}
;
 //BA.debugLineNum = 218;BA.debugLine="labProgramTypeText = ProgramType";
_labprogramtypetext = _programtype;
 break;
case 7:
 //BA.debugLineNum = 221;BA.debugLine="ProgramText = \"\"";
_programtext = "";
 //BA.debugLineNum = 222;BA.debugLine="For j = 6 To index - 1";
{
final int step171 = 1;
final int limit171 = (int) (_index-1);
for (_j = (int) (6); (step171 > 0 && _j <= limit171) || (step171 < 0 && _j >= limit171); _j = ((int)(0 + _j + step171))) {
 //BA.debugLineNum = 223;BA.debugLine="ProgramText  = ProgramText  & Chr(Ack(j))";
_programtext = _programtext+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(_ack[_j]));
 }
};
 //BA.debugLineNum = 225;BA.debugLine="labProgramText = ProgramText";
_labprogramtext = _programtext;
 break;
case 8:
 //BA.debugLineNum = 229;BA.debugLine="DataRateText = Floor(Ack(6) & Ack(7)) & \" Kbps\"";
_dataratetext = BA.NumberToString(anywheresoftware.b4a.keywords.Common.Floor((double)(Double.parseDouble(BA.NumberToString(_ack[(int) (6)])+BA.NumberToString(_ack[(int) (7)])))))+" Kbps";
 break;
case 9:
 //BA.debugLineNum = 232;BA.debugLine="Strength = Ack(6)";
_strength = (byte) (_ack[(int) (6)]);
 //BA.debugLineNum = 233;BA.debugLine="labStrengthText = Strength";
_labstrengthtext = BA.NumberToString(_strength);
 //BA.debugLineNum = 234;BA.debugLine="pbStrengthProgress = Strength";
_pbstrengthprogress = _strength;
 break;
case 10:
 //BA.debugLineNum = 237;BA.debugLine="If Ack(6) = 0x47 Then";
if (_ack[(int) (6)]==0x47) { 
 //BA.debugLineNum = 238;BA.debugLine="DABSearch = False";
_dabsearch = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 239;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x16,0x01,0x";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x16),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 }else {
 //BA.debugLineNum = 241;BA.debugLine="labEventText = \"DABSearch ...  \" & Ack(6)";
_labeventtext = "DABSearch ...  "+BA.NumberToString(_ack[(int) (6)]);
 };
 break;
case 11:
 //BA.debugLineNum = 245;BA.debugLine="Esamble = \"\"";
_esamble = "";
...
for (_j = (int) (6); (step190 > 0 && _j <= limit190) || (step190 < 0 && _j >= limit190); _j = ((int)(0 + _j + step190))) {
 //BA.debugLineNum = 247;BA.debugLine="Esamble = Esamble & Chr(Ack(j))";
_esamble = _esamble+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(_ack[_j]));
 }
};
 //BA.debugLineNum = 249;BA.debugLine="labProgram2Text = Esamble";
_labprogram2text = _esamble;
 break;
case 12:
 //BA.debugLineNum = 252;BA.debugLine="AllDAB = Bit.ParseInt(Bit.ToHexString(Ack(6)) &";
_alldab = anywheresoftware.b4a.keywords.Common.Bit.ParseInt(anywheresoftware.b4a.keywords.Common.Bit.ToHexString(_ack[(int) (6)])+anywheresoftware.b4a.keywords.Common.Bit.ToHexString(_ack[(int) (7)])+anywheresoftware.b4a.keywords.Common.Bit.ToHexString(_ack[(int) (8)])+anywheresoftware.b4a.keywords.Common.Bit.ToHexString(_ack[(int) (9)]),(int) (16));
 //BA.debugLineNum = 253;BA.debugLine="labEventText =\"Copying \" & 0 & \"/\" & AllDAB";
_labeventtext = "Copying "+BA.NumberToString(0)+"/"+BA.NumberToString(_alldab);
 //BA.debugLineNum = 254;BA.debugLine="lstDAB.Clear";
_lstdab.Clear();
 //BA.debugLineNum = 256;BA.debugLine="iStep = 0";
_istep = (int) (0);
 //BA.debugLineNum = 257;BA.debugLine="MyTimer.Interval = 500";
_mytimer.setInterval((long) (500));
 //BA.debugLineNum = 258;BA.debugLine="Wait(3)";
_wait((int) (3));
 //BA.debugLineNum = 259;BA.debugLine="FillList = True";
_filllist = anywheresoftware.b4a.keywords.Common.True;
 break;
case 13:
 //BA.debugLineNum = 262;BA.debugLine="ProgramName2 = \"\"";
_programname2 = "";
 //BA.debugLineNum = 263;BA.debugLine="For j = 6 To index - 1";
{
final int step204 = 1;
final int limit204 = (int) (_index-1);
for (_j = (int) (6); (step204 > 0 && _j <= limit204) || (step204 < 0 && _j >= limit204); _j = ((int)(0 + _j + step204))) {
 //BA.debugLineNum = 264;BA.debugLine="If Ack(j) <> 0 Then";
if (_ack[_j]!=0) { 
 //BA.debugLineNum = 265;BA.debugLine="ProgramName2 = ProgramName2 & Chr(Ack(j))";
_programname2 = _programname2+BA.ObjectToString(anywheresoftware.b4a.keywords.Common.Chr(_ack[_j]));
 };
 }
};
 //BA.debugLineNum = 269;BA.debugLine="If FillList Then";
if (_filllist) { 
 //BA.debugLineNum = 270;BA.debugLine="Log(ProgramName2)";
anywheresoftware.b4a.keywords.Common.Log(_programname2);
 //BA.debugLineNum = 271;BA.debugLine="Dim lastProgramName As String";
_lastprogramname = "";
 //BA.debugLineNum = 272;BA.debugLine="If lstDAB.Size > 0 Then";
if (_lstdab.getSize()>0) { 
 //BA.debugLineNum = 273;BA.debugLine="lastProgramName = lstDAB.Get(lstDAB.Size-1)";
_lastprogramname = BA.ObjectToString(_lstdab.Get((int) (_lstdab.getSize()-1)));
 }else {
 //BA.debugLineNum = 275;BA.debugLine="lastProgramName = \"\"";
_lastprogramname = "";
 };
 //BA.debugLineNum = 278;BA.debugLine="If lastProgramName <> ProgramName2 Then";
if ((_lastprogramname).equals(_programname2) == false) { 
 //BA.debugLineNum = 279;BA.debugLine="iStep = lstDAB.Size+1";
_istep = (int) (_lstdab.getSize()+1);
 //BA.debugLineNum = 280;BA.debugLine="lstDAB.Add(ProgramName2)";
_lstdab.Add((Object)(_programname2));
 //BA.debugLineNum = 281;BA.debugLine="labEventText =\"Copying \" & lstDAB.Size & \"/\"";
_labeventtext = "Copying "+BA.NumberToString(_lstdab.getSize())+"/"+BA.NumberToString(_alldab);
 };
 //BA.debugLineNum = 283;BA.debugLine="MyTimer_Tick";
_mytimer_tick();
 }else {
 //BA.debugLineNum = 285;BA.debugLine="Dim b() As Byte = ProgramName2.GetBytes(\"UTF8\"";
_b = _programname2.getBytes("UTF8");
 //BA.debugLineNum = 286;BA.debugLine="ProgramName2 = BytesToString(b, 0, b.Length,";
_programname2 = anywheresoftware.b4a.keywords.Common.BytesToString(_b,(int) (0),_b.length,"UTF8");
 //BA.debugLineNum = 287;BA.debugLine="ProgramNameText = ProgramName2";
_programnametext = _programname2;
 //BA.debugLineNum = 288;BA.debugLine="ProgramName2=ProgramName2.Replace(\" \",\"\")";
...
;
 break;
case 1:
 //BA.debugLineNum = 294;BA.debugLine="If Ack(2) = 0x01 And Ack(3) = 0x01 And ClearData";
if (_ack[(int) (2)]==0x01 && _ack[(int) (3)]==0x01 && _cleardatabase) { 
 //BA.debugLineNum = 295;BA.debugLine="iLoop = iLoop +1";
_iloop = (int) (_iloop+1);
 //BA.debugLineNum = 296;BA.debugLine="If iLoop > 2 Then";
if (_iloop>2) { 
 //BA.debugLineNum = 297;BA.debugLine="SysReady.Enabled = False";
_sysready.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 298;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x03,0x01,0x";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x03),(byte) (0x01),(byte) (0x00),(byte) (0x02),(byte) (0x00),(byte) (0x47),(byte) (0xfd)});
 //BA.debugLineNum = 299;BA.debugLine="DABSearch = True";
_dabsearch = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 300;BA.debugLine="iLoop = 0";
_iloop = (int) (0);
 //BA.debugLineNum = 301;BA.debugLine="MyTimer.Enabled = True";
_mytimer.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 302;BA.debugLine="ClearDatabase = False";
_cleardatabase = anywheresoftware.b4a.keywords.Common.False;
 };
 }else {
 //BA.debugLineNum = 305;BA.debugLine="If MuteResponse = \"0\" Then";
if ((_muteresponse).equals("0")) { 
 //BA.debugLineNum = 306;BA.debugLine="Log(\"Mute has been performed, can now close ra";
anywheresoftware.b4a.keywords.Common.Log("Mute has been performed, can now close radio service");
 //BA.debugLineNum = 307;BA.debugLine="MuteResponse = \"1\"";
_muteresponse = "1";
 //BA.debugLineNum = 308;BA.debugLine="ExitApp";
_exitapp();
 };
 //BA.debugLineNum = 311;BA.debugLine="If iIndex < 3 Then";
if (_iindex<3) { 
 //BA.debugLineNum = 313;BA.debugLine="Select(iIndex)";
switch (BA.switchObjectToInt((_iindex),(int) ((0)),(int) ((1)),(int) ((2)))) {
case 0:
 //BA.debugLineNum = 316;BA.debugLine="If part = 1 Then iIndex = iIndex + 1";
if (_part==1) { 
_iindex = (int) (_iindex+1);};
 //BA.debugLineNum = 317;BA.debugLine="Log(\"Responded\")";
anywheresoftware.b4a.keywords.Common.Log("Responded");
 break;
case 1:
 //BA.debugLineNum = 319;BA.debugLine="If part = 2 Then iIndex = iIndex + 1";
if (_part==2) { 
_iindex = (int) (_iindex+1);};
 //BA.debugLineNum = 320;BA.debugLine="Log(\"Responded\")";
anywheresoftware.b4a.keywords.Common.Log("Responded");
 break;
case 2:
 //BA.debugLineNum = 322;BA.debugLine="If part = 3 Then iIndex = iIndex + 1";
if (_part==3) { 
_iindex = (int) (_iindex+1);};
...
;
 //BA.debugLineNum = 330;BA.debugLine="ArgumentsList.Initialize()";
_argumentslist.Initialize();
 //BA.debugLineNum = 331;BA.debugLine="ArgumentsList.Add(labEventText)";
_argumentslist.Add((Object)(_labeventtext));
 //BA.debugLineNum = 332;BA.debugLine="ArgumentsList.Add(labFreqText)";
_argumentslist.Add((Object)(_labfreqtext));
 //BA.debugLineNum = 333;BA.debugLine="ArgumentsList.Add(labStrengthText)";
_argumentslist.Add((Object)(_labstrengthtext));
 //BA.debugLineNum = 334;BA.debugLine="ArgumentsList.Add(pbStrengthProgress)";
_argumentslist.Add((Object)(_pbstrengthprogress));
 //BA.debugLineNum = 335;BA.debugLine="ArgumentsList.Add(labVolumeText)";
_argumentslist.Add((Object)(_labvolumetext));
 //BA.debugLineNum = 336;BA.debugLine="ArgumentsList.Add(ProgramNameText)";
_argumentslist.Add((Object)(_programnametext));
 //BA.debugLineNum = 337;BA.debugLine="ArgumentsList.Add(labProgramTypeText)";
_argumentslist.Add((Object)(_labprogramtypetext));
 //BA.debugLineNum = 338;BA.debugLine="ArgumentsList.Add(labProgram2Text)";
_argumentslist.Add((Object)(_labprogram2text));
 //BA.debugLineNum = 339;BA.debugLine="ArgumentsList.Add(labProgramText)";
_argumentslist.Add((Object)(_labprogramtext));
 //BA.debugLineNum = 340;BA.debugLine="ArgumentsList.Add(StereoModeText)";
_argumentslist.Add((Object)(_stereomodetext));
 //BA.debugLineNum = 341;BA.debugLine="ArgumentsList.Add(DataRateText)";
_argumentslist.Add((Object)(_dataratetext));
 //BA.debugLineNum = 343;BA.debugLine="Dim Changed As Boolean = False";
_changed = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 345;BA.debugLine="If PreviousNotificationText <> ProgramNameText Th";
if ((_previousnotificationtext).equals(_programnametext) == false) { 
 //BA.debugLineNum = 346;BA.debugLine="RadioNotification.ContentText = ProgramNameText";
_radionotification.setContentText(_programnametext);
 //BA.debugLineNum = 347;BA.debugLine="PreviousNotificationText = ProgramNameText";
_previousnotificationtext = _programnametext;
 //BA.debugLineNum = 348;BA.debugLine="Changed = True";
_changed = anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 351;BA.debugLine="If PreviousNotificationText2 <> labEventText Then";
if ((_previousnotificationtext2).equals(_labeventtext) == false) { 
 //BA.debugLineNum = 352;BA.debugLine="RadioNotification.ContentInfo = labEventText";
_radionotification.setContentInfo(_labeventtext);
 //BA.debugLineNum = 353;BA.debugLine="PreviousNotificationText2 = labEventText";
_previousnotificationtext2 = _labeventtext;
 //BA.debugLineNum = 354;BA.debugLine="Changed = True";
_changed = anywheresoftware.b4a.keywords.Common.True;
 };
 //BA.debugLineNum = 357;BA.debugLine="If Changed Then";
if (_changed) { 
 //BA.debugLineNum = 358;BA.debugLine="Service.StartForeground(1,RadioNotification.GetN";
mostCurrent._service.StartForeground((int) (1),_radionotification.GetNotification(processBA));
 };
 //BA.debugLineNum = 361;BA.debugLine="If IsPaused(Main) <> True Then";
if (anywheresoftware.b4a.keywords.Common.IsPaused(processBA,(Object)(mostCurrent._main.getObject()))!=anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 362;BA.debugLine="CallSub2(Main,\"SetEvaluatedData\",ArgumentsList)";
...
public static String  _exitapp() throws Exception{
 //BA.debugLineNum = 665;BA.debugLine="Sub ExitApp 'Close the whole app";
 //BA.debugLineNum = 666;BA.debugLine="Log(\"Attempting To close app when ServiceStarted";
anywheresoftware.b4a.keywords.Common.Log("Attempting To close app when ServiceStarted = "+BA.ObjectToString(_servicestarted));
 //BA.debugLineNum = 668;BA.debugLine="If ServiceStarted And Connected Then";
if (_servicestarted && _connected) { 
 //BA.debugLineNum = 670;BA.debugLine="If MuteResponse = \"Null\" Then";
if ((_muteresponse).equals("Null")) { 
 //BA.debugLineNum = 671;BA.debugLine="SaveSettings";
_savesettings();
 //BA.debugLineNum = 674;BA.debugLine="If ForceClosing = False Then";
if (_forceclosing==anywheresoftware.b4a.keywords.Common.False) { 
 //BA.debugLineNum = 675;BA.debugLine="Log(\"Attempting to mute\")";
anywheresoftware.b4a.keywords.Common.Log("Attempting to mute");
 //BA.debugLineNum = 677;BA.debugLine="MuteResponse = \"0\"";
_muteresponse = "0";
 //BA.debugLineNum = 679;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x0C,0x01,0x";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x0c),(byte) (0x01),(byte) (0x00),(byte) (0x01),(byte) (0x00),(byte) (0xfd)});
 //BA.debugLineNum = 681;BA.debugLine="If Not(TryAgain.IsInitialized) Then TryAgain.I";
if (anywheresoftware.b4a.keywords.Common.Not(_tryagain.IsInitialized())) { 
_tryagain.Initialize(processBA,"TryAgain",(long) (500));};
 //BA.debugLineNum = 682;BA.debugLine="TryAgain.Enabled = True";
_tryagain.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
 };
 //BA.debugLineNum = 686;BA.debugLine="If MuteResponse = \"1\" Or ForceClosing = True The";
if ((_muteresponse).equals("1") || _forceclosing==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 687;BA.debugLine="Log(\"What the fuck\")";
anywheresoftware.b4a.keywords.Common.Log("What the fuck");
 //BA.debugLineNum = 689;BA.debugLine="RunCloseProcesses";
_runcloseprocesses();
 //BA.debugLineNum = 692;BA.debugLine="If IsPaused(Main) = False Then";
...
public static String  _labelclean() throws Exception{
 //BA.debugLineNum = 369;BA.debugLine="Sub LabelClean";
 //BA.debugLineNum = 370;BA.debugLine="If Connected Then";
if (_connected) { 
 //BA.debugLineNum = 371;BA.debugLine="MyTimer.Enabled = False";
_mytimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 372;BA.debugLine="Esamble = \"\"";
_esamble = "";
 //BA.debugLineNum = 373;BA.debugLine="ProgramName = \"\"";
_programname = "";
 //BA.debugLineNum = 374;BA.debugLine="ProgramName2 = \"\"";
_programname2 = "";
 //BA.debugLineNum = 375;BA.debugLine="ProgramText = \"\"";
_programtext = "";
 //BA.debugLineNum = 376;BA.debugLine="ProgramType = \"\"";
_programtype = "";
 //BA.debugLineNum = 377;BA.debugLine="Strength = 0";
_strength = (byte) (0);
 //BA.debugLineNum = 378;BA.debugLine="iIndex = 3";
_iindex = (int) (3);
 //BA.debugLineNum = 379;BA.debugLine="MyTimer.Enabled = True";
_mytimer.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 };
...
String _d3 = "";
String _d = "";
 //BA.debugLineNum = 486;BA.debugLine="Sub MyTimer_Tick";
 //BA.debugLineNum = 490;BA.debugLine="If Connected Then";
if (_connected) { 
 //BA.debugLineNum = 491;BA.debugLine="If DABSearch Then 'If a dab search has been perf";
if (_dabsearch) { 
 //BA.debugLineNum = 492;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x14,0x01,0x0";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x14),(byte) (0x01),(byte) (0x00),(byte) (0x04),(byte) (0x00),(byte) (0x00),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 ...
 //BA.debugLineNum = 494;BA.debugLine="If FillList Then";
if (_filllist) { 
 //BA.debugLineNum = 495;BA.debugLine="If iStep < AllDAB Then";
if (_istep<_alldab) { 
 //BA.debugLineNum = 496;BA.debugLine="Log(iStep)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_istep));
 //BA.debugLineNum = 497;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x1A,0x01,0";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x1a),(byte) (0x01),(byte) (0x00),(byte) (0x05),(byte) (0x00),(byte) (0x00),(byte) (0x00),(byte) (_istep),(byte) (0x01),(byte) (0xfd)});
 ...
 //BA.debugLineNum = 500;BA.debugLine="iStep = 0";
_istep = (int) (0);
 //BA.debugLineNum = 501;BA.debugLine="FillList = False";
_filllist = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 502;BA.debugLine="MyTimer.Interval = 25 'Go back to normal send";
_mytimer.setInterval((long) (25));
 //BA.debugLineNum = 503;BA.debugLine="CallSub(Main, \"updateStationList\")";
anywheresoftware.b4a.keywords.Common.CallSubNew(processBA,(Object)(mostCurrent._main.getObject()),"updateStationList");
 };
 }else {
 //BA.debugLineNum = 506;BA.debugLine="If isDAB And DAB Then 'If in DAB mode";
if (_isdab && _dab) { 
 //BA.debugLineNum = 509;BA.debugLine="Select iIndex";
switch (_iindex) {
case 0:
 //BA.debugLineNum = 511;BA.debugLine="Log(\"Set to Fequency \" & Frequenz)";
anywheresoftware.b4a.keywords.Common.Log("Set to Fequency "+BA.NumberToString(_frequenz));
 //BA.debugLineNum = 512;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x00,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x00),(byte) (0x01),(byte) (0x00),(byte) (0x05),(byte) (0x00),(byte) (0x00),(byte) (0x00),(byte) (0x00),(byte) (_frequenz),(byte) (0xfd)});
 //BA.debugLineNum = 513;BA.debugLine="part = 1";
_part = (int) (1);
 break;
case 1:
 //BA.debugLineNum = 515;BA.debugLine="Log(\"Setting volume\")";
anywheresoftware.b4a.keywords.Common.Log("Setting volume");
 //BA.debugLineNum = 516;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x0C,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x0c),(byte) (0x01),(byte) (0x00),(byte) (0x01),_volume,(byte) (0xfd)});
 //BA.debugLineNum = 517;BA.debugLine="part = 2";
_part = (int) (2);
 break;
case 2:
 //BA.debugLineNum = 519;BA.debugLine="Log(\"Setting stereoMode\")";
anywheresoftware.b4a.keywords.Common.Log("Setting stereoMode");
 //BA.debugLineNum = 520;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x09,0x01";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x09),(byte) (0x01),(byte) (0x00),(byte) (0x01),(byte) (0x01),(byte) (0xfd)});
 //BA.debugLineNum = 521;BA.debugLine="part = 3";
_part = (int) (3);
 break;
case 3:
 //BA.debugLineNum = 523;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x0D,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x0d),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 break;
case 4:
 //BA.debugLineNum = 525;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x15,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x15),(byte) (0x01),(byte) (0x00),(byte) (0x05),(byte) (0x00),(byte) (0x00),(byte) (0x00),(byte) (_frequenz),(byte) (0x01),(byte) (0xfd)});
 break;
case 5:
 //BA.debugLineNum = 527;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x1A,0x01";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x1a),(byte) (0x01),(byte) (0x00),(byte) (0x05),(byte) (0x00),(byte) (0x00),(byte) (0x00),(byte) (_frequenz),(byte) (0x01),(byte) (0xfd)});
 break;
case 6:
 //BA.debugLineNum = 529;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x07,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x07),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 break;
case 7:
 //BA.debugLineNum = 531;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x13,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x13),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 break;
case 8:
 //BA.debugLineNum = 533;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x0E,0x01,";
...
;
 ...
 //BA.debugLineNum = 546;BA.debugLine="Select iIndex";
switch (_iindex) {
case 0:
 //BA.debugLineNum = 548;BA.debugLine="Dim d1,d2,d3,d As String";
_d1 = "";
_d2 = "";
_d3 = "";
_d = "";
 //BA.debugLineNum = 549;BA.debugLine="d =  Bit.ToHexString(Frequenz)";
_d = anywheresoftware.b4a.keywords.Common.Bit.ToHexString(_frequenz);
 //BA.debugLineNum = 550;BA.debugLine="d1 = Bit.ParseInt(d.SubString2(0,1), 16)";
_d1 = BA.NumberToString(anywheresoftware.b4a.keywords.Common.Bit.ParseInt(_d.substring((int) (0),(int) (1)),(int) (16)));
 //BA.debugLineNum = 551;BA.debugLine="d2 = Bit.ParseInt(d.SubString2(1,3), 16)";
_d2 = BA.NumberToString(anywheresoftware.b4a.keywords.Common.Bit.ParseInt(_d.substring((int) (1),(int) (3)),(int) (16)));
 //BA.debugLineNum = 552;BA.debugLine="d3 = Bit.ParseInt(d.SubString2(3,5), 16)";
_d3 = BA.NumberToString(anywheresoftware.b4a.keywords.Common.Bit.ParseInt(_d.substring((int) (3),(int) (5)),(int) (16)));
 //BA.debugLineNum = 553;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x00,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x00),(byte) (0x01),(byte) (0x00),(byte) (0x05),(byte) (0x01),(byte) (0x00),(byte)(Double.parseDouble(_d1)),(byte)(Double.parseDouble(_d2)),(byte)(Double.parseDouble(_d3)),(byte) (0xfd)});
 break;
case 1:
 //BA.debugLineNum = 555;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x0C,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x0c),(byte) (0x01),(byte) (0x00),(byte) (0x01),_volume,(byte) (0xfd)});
 break;
case 2:
 //BA.debugLineNum = 557;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x09,0x01";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x09),(byte) (0x01),(byte) (0x00),(byte) (0x01),(byte) (0x01),(byte) (0xfd)});
 break;
case 3:
 //BA.debugLineNum = 559;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x0D,0x01";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x0d),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 break;
case 4:
 //BA.debugLineNum = 561;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x07,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x07),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 break;
case 5:
 //BA.debugLineNum = 563;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x08,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x08),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 break;
case 6:
 //BA.debugLineNum = 565;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x0E,0x01";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x0e),(byte) (0x01),(byte) (0x00),(byte) (0x04),(byte) (0xff),(byte) (0xff),(byte) (0xff),(byte) (0xff),(byte) (0xfd)});
 break;
case 7:
 //BA.debugLineNum = 567;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x0F,0x01";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x0f),(byte) (0x01),(byte) (0x00),(byte) (0x05),(byte) (0xff),(byte) (0xff),(byte) (0xff),(byte) (0xff),(byte) (0x01),(byte) (0xfd)});
 break;
case 8:
 //BA.debugLineNum = 569;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x05,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x05),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 break;
case 9:
 //BA.debugLineNum = 571;BA.debugLine="SendRadio(Array As Byte(0xFE,0x01,0x10,0x01,";
_sendradio(new byte[]{(byte) (0xfe),(byte) (0x01),(byte) (0x10),(byte) (0x01),(byte) (0x00),(byte) (0x00),(byte) (0xfd)});
 //BA.debugLineNum = 572;BA.debugLine="iIndex = 3";
_iindex = (int) (3);
...
;
 ...
 //BA.debugLineNum = 576;BA.debugLine="If iIndex > 2 Then iIndex = iIndex + 1";
if (_iindex>2) { 
_iindex = (int) (_iindex+1);};
 //BA.debugLineNum = 578;BA.debugLine="If iIndex > 12 Then iIndex = 3";
if (_iindex>12) { 
_iindex = (int) (3);};
 };
 };
...
anywheresoftware.b4a.objects.usb.UsbManagerWrapper.UsbDeviceWrapper _usbdvc = null;
 //BA.debugLineNum = 398;BA.debugLine="Sub OpenRadio";
 //BA.debugLineNum = 400;BA.debugLine="Dim UsbMngr As UsbManager  ' USB library";
_usbmngr = new anywheresoftware.b4a.objects.usb.UsbManagerWrapper();
 //BA.debugLineNum = 402;BA.debugLine="UsbMngr.Initialize";
_usbmngr.Initialize();
 //BA.debugLineNum = 403;BA.debugLine="Dim UsbDevices() As UsbDevice  ' USB library";
...
;
 //BA.debugLineNum = 405;BA.debugLine="UsbDevices = UsbMngr.GetDevices";
_usbdevices = _usbmngr.GetDevices();
 //BA.debugLineNum = 409;BA.debugLine="If UsbDevices.Length > 0 Then";
if (_usbdevices.length>0) { 
 //BA.debugLineNum = 410;BA.debugLine="Log(UsbDevices.Length)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_usbdevices.length));
 //BA.debugLineNum = 412;BA.debugLine="For i = 0 To UsbDevices.Length - 1";
{
final int step324 = 1;
final int limit324 = (int) (_usbdevices.length-1);
for (_i = (int) (0); (step324 > 0 && _i <= limit324) || (step324 < 0 && _i >= limit324); _i = ((int)(0 + _i + step324))) {
 //BA.debugLineNum = 413;BA.debugLine="Dim UsbDvc As UsbDevice";
_usbdvc = new anywheresoftware.b4a.objects.usb.UsbManagerWrapper.UsbDeviceWrapper();
 //BA.debugLineNum = 414;BA.debugLine="UsbDvc = UsbDevices(i)";
_usbdvc = _usbdevices[_i];
 //BA.debugLineNum = 416;BA.debugLine="If (UsbDvc.ProductId = UsbPid) And (UsbDvc.Ven";
if ((_usbdvc.getProductId()==_usbpid) && (_usbdvc.getVendorId()==_usbvid)) { 
 //BA.debugLineNum = 417;BA.debugLine="USB.SetCustomDevice(USB.DRIVER_CDCACM, UsbVid,";
_usb.SetCustomDevice(_usb.DRIVER_CDCACM,_usbvid,_usbpid);
 //BA.debugLineNum = 419;BA.debugLine="If Not(UsbMngr.HasPermission(UsbDvc)) Then";
if (anywheresoftware.b4a.keywords.Common.Not(_usbmngr.HasPermission((android.hardware.usb.UsbDevice)(_usbdvc.getObject())))) { 
 //BA.debugLineNum = 420;BA.debugLine="UsbMngr.RequestPermission(UsbDvc)";
_usbmngr.RequestPermission((android.hardware.usb.UsbDevice)(_usbdvc.getObject()));
 };
 //BA.debugLineNum = 423;BA.debugLine="If UsbMngr.HasPermission(UsbDvc) Then";
if (_usbmngr.HasPermission((android.hardware.usb.UsbDevice)(_usbdvc.getObject()))) { 
 //BA.debugLineNum = 424;BA.debugLine="Dev = USB.Open(57600, i + 1)";
_dev = _usb.Open(processBA,(int) (57600),(int) (_i+1));
 //BA.debugLineNum = 426;BA.debugLine="If Dev <> USB.USB_NONE Then";
if (_dev!=_usb.USB_NONE) { 
 //BA.debugLineNum = 427;BA.debugLine="USBTimer.Enabled = False";
_usbtimer.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 428;BA.debugLine="Log(\"Connected successfully!\")";
anywheresoftware.b4a.keywords.Common.Log("Connected successfully!");
 //BA.debugLineNum = 430;BA.debugLine="astreams.Initialize(USB.GetInputStream, USB.";
_astreams.Initialize(processBA,_usb.GetInputStream(),_usb.GetOutputStream(),"astreams");
 //BA.debugLineNum = 432;BA.debugLine="RTS(True)";
_rts(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 433;BA.debugLine="DTR(False)";
_dtr(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 435;BA.debugLine="If Not(SysReady.IsInitialized) Then SysReady";
if (anywheresoftware.b4a.keywords.Common.Not(_sysready.IsInitialized())) { 
_sysready.Initialize(processBA,"SysReady",(long) (500));};
 //BA.debugLineNum = 436;BA.debugLine="If Not(MyTimer.IsInitialized) Then MyTimer.I";
if (anywheresoftware.b4a.keywords.Common.Not(_mytimer.IsInitialized())) { 
_mytimer.Initialize(processBA,"MyTimer",(long) (25));};
 //BA.debugLineNum = 438;BA.debugLine="StartMediaKeys";
_startmediakeys();
 //BA.debugLineNum = 439;BA.debugLine="Mediakey.MediaButton(KeyCodes.KEYCODE_MEDIA_";
_mediakey.MediaButton(processBA,anywheresoftware.b4a.keywords.Common.KeyCodes.KEYCODE_MEDIA_STOP);
 //BA.debugLineNum = 440;BA.debugLine="AudioFocusManager.Initialize(\"AudioFocusMana";
_audiofocusmanager.Initialize(processBA,"AudioFocusManager");
 //BA.debugLineNum = 441;BA.debugLine="AudioFocusManager.requestFocus";
_audiofocusmanager.requestFocus();
 //BA.debugLineNum = 442;BA.debugLine="Ducked = False";
_ducked = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 444;BA.debugLine="Connected = True";
_connected = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 445;BA.debugLine="SetUpNotfication";
_setupnotfication();
 //BA.debugLineNum = 446;BA.debugLine="Broadcast.sendBroadcast(\"com.freshollie.radi";
_broadcast.sendBroadcast("com.freshollie.radioapp.RUNNING");
 //BA.debugLineNum = 448;BA.debugLine="DAB = True";
_dab = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 449;BA.debugLine="LoadSettings";
_loadsettings();
 //BA.debugLineNum = 450;BA.debugLine="iIndex = 0";
_iindex = (int) (0);
 //BA.debugLineNum = 451;BA.debugLine="part = 0";
_part = (int) (0);
 //BA.debugLineNum = 452;BA.debugLine="Start = True";
_start = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 453;BA.debugLine="MuteResponse = \"Null\"";
_muteresponse = "Null";
 //BA.debugLineNum = 454;BA.debugLine="ForceClosing = False";
_forceclosing = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 455;BA.debugLine="Wait(1)";
_wait((int) (1));
 //BA.debugLineNum = 457;BA.debugLine="MyTimer.Enabled = True";
_mytimer.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 458;BA.debugLine="Return";
if (true) return "";
 };
 };
 //BA.debugLineNum = 462;BA.debugLine="Exit";
if (true) break;
 };
 }
};
 };
 //BA.debugLineNum = 466;BA.debugLine="ForceClosing = True";
_forceclosing = anywheresoftware.b4a.keywords.Common.True;
 //BA.debugLineNum = 467;BA.debugLine="ExitApp";
_exitapp();
...
_muteresponse = "";
 //BA.debugLineNum = 38;BA.debugLine="Private session As JavaObject";
_session = new anywheresoftware.b4j.object.JavaObject();
 //BA.debugLineNum = 40;BA.debugLine="Dim EnterClickedReturnValue As Boolean";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 383;BA.debugLine="Sub RTS(Bool As Boolean)";
 //BA.debugLineNum = 384;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 385;BA.debugLine="r.Target = USB";
_r.Target = (Object)(_usb);
 //BA.debugLineNum = 386;BA.debugLine="r.Target = r.getField(\"driver\")";
_r.Target = _r.GetField("driver");
 //BA.debugLineNum = 387;BA.debugLine="r.RunMethod2(\"setRTS\", Bool, \"java.lang.boolean\")";
...
public static String  _runcloseprocesses() throws Exception{
 //BA.debugLineNum = 636;BA.debugLine="Sub RunCloseProcesses";
...
_session.RunMethod("release",(Object[])(anywheresoftware.b4a.keywords.Common.Null));
 //BA.debugLineNum = 647;BA.debugLine="Broadcast.sendBroadcast(\"com.freshollie.radioapp.";
...
_connected = anywheresoftware.b4a.keywords.Common.False;
 //BA.debugLineNum = 654;BA.debugLine="ForceClosing = False";
_forceclosing = anywheresoftware.b4a.keywords.Common.False;
...
public static String  _sendradio(byte[] _buffer) throws Exception{
 //BA.debugLineNum = 475;BA.debugLine="Sub SendRadio(buffer() As Byte)";
 //BA.debugLineNum = 476;BA.debugLine="If Connected Then astreams.Write(buffer)";
if (_connected) { 
...
public static String  _sysready_tick() throws Exception{
 //BA.debugLineNum = 482;BA.debugLine="Sub SysReady_Tick";
 //BA.debugLineNum = 483;BA.debugLine="SendRadio(Array As Byte(0xFE,0x00,0x00,0x01,0x00,";
...
public static String  _tryagain_tick() throws Exception{
 //BA.debugLineNum = 626;BA.debugLine="Sub TryAgain_tick";
 //BA.debugLineNum = 627;BA.debugLine="If MuteResponse = \"0\" Then";
if ((_muteresponse).equals("0")) { 
 //BA.debugLineNum = 628;BA.debugLine="MuteResponse = \"Null\"";
_muteresponse = "Null";
 //BA.debugLineNum = 629;BA.debugLine="ExitApp";
_exitapp();
 };
 //BA.debugLineNum = 632;BA.debugLine="TryAgain.Enabled = False";
...
public static String  _usbtimer_tick() throws Exception{
 //BA.debugLineNum = 584;BA.debugLine="Sub USBTimer_Tick";
 //BA.debugLineNum = 585;BA.debugLine="Log(\"Trying to connect again\")";
anywheresoftware.b4a.keywords.Common.Log("Trying to connect again");
 //BA.debugLineNum = 586;BA.debugLine="If Not (Connected) Then OpenRadio";
...
long _ti = 0L;
 //BA.debugLineNum = 48;BA.debugLine="Sub Wait(Sekunden As Int)";
 //BA.debugLineNum = 49;BA.debugLine="Dim Ti As Long";
_ti = 0L;
 //BA.debugLineNum = 50;BA.debugLine="Ti = DateTime.Now + (Sekunden * 1000)";
_ti = (long) (anywheresoftware.b4a.keywords.Common.DateTime.getNow()+(_sekunden*1000));
 //BA.debugLineNum = 51;BA.debugLine="Do While DateTime.Now < Ti";
while (anywheresoftware.b4a.keywords.Common.DateTime.getNow()<_ti) {
 //BA.debugLineNum = 52;BA.debugLine="DoEvents";
